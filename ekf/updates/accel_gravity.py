...
class AccelGravityUpdate(UpdateBase):
    ...
    def __init__(self, R_accel=None, gravity_threshold=0.5):
        ...
        self.gravity_threshold = gravity_threshold  # Only update if |a| approx g
    ...
    def compute_jacobian(self, x, measurement=None):
        ...
        # Full Jacobian H (3x16):
        # [H_q(3x4), zeros(3x3), zeros(3x3), zeros(3x3), I(3x3)]
        #  quat      pos         vel         bg          ba    
